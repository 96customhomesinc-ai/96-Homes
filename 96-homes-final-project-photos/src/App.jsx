export default function Homes96Website() {
  ...
  const projects = [
    ...
    },
    {
      ...
      type: "Residential Renovation",
      details:
        "Clean, modern bathroom finishes with upgraded fixtures, tile, vanities, and shower spaces.",
    ...
    },
    {
      ...
      type: "Residential Renovation",
      details:
        "A bright bathroom update with refined finishes and a clean modern style.",
      image: "/images/bathroom-renovation-1.jpeg",
    },
    {
      title: "Custom Shower & Vanity",
      type: "Residential Renovation",
      details:
        "A finished bathroom space with glass shower, double vanity, and modern black hardware.",
      image: "/images/bathroom-renovation-3.jpeg",
    },
    {
      title: "Basement Bar",
      ...
      <header className="sticky top-0 z-50 border-b border-stone-200 bg-stone-50/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <a
            ...
            className="hidden md:block rounded-full bg-black px-6 py-2 text-sm text-white hover:opacity-90"
          >
            Call Now
          </a>
        </div>
