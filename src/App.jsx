  ...
  const projects = [
    {
      ...
      details: "A thoughtfully planned residential build with tailored design, quality finishes, and hands-on project management.",
      highlights: ["Custom design execution", "Complete project management", "Premium interior finishes"],
    ...
    },
    {
      ...
      type: "Renovation",
      location: "Calgary, Alberta",
      details: "A modern kitchen renovation designed around function, durable materials, and refined finishes.",
    ...
    },
    {
      ...
      location: "Calgary, Alberta",
      details: "A complete transformation featuring structural improvements, modern upgrades, and elevated interior details.",
      highlights: ["Full-space transformation", "Structural improvements", "Custom finish selections"],
    ...
    },
    {
      ...
      location: "Calgary, Alberta",
      details: "A complete bathroom renovation featuring a glass shower, freestanding tub, custom vanity, and premium finishes.",
      highlights: ["Glass shower", "Freestanding tub", "Custom vanity and fixtures"],
    ...
    },
    {
      ...
      location: "Calgary, Alberta",
      details: "A finished lower-level bar and entertainment area created for comfort, function, and everyday use.",
    ...
    <div className="min-h-screen bg-stone-50 text-slate-900">
      ...
      <section id="services" className="py-24 bg-slate-900 text-white">
        <div className="mb-12 flex justify-center">
          <img src={logo} alt="96 Homes" className="h-16 w-auto object-contain opacity-90" />
        </div>
      ...
      <section id="process" className="bg-slate-900 py-28 text-white">
        <div className="mx-auto max-w-7xl px-6">
          <p className="text-center text-sm font-medium uppercase tracking-[0.24em] text-stone-300">Our Process</p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-center text-slate-300">
            From the first conversation to the final walkthrough, we keep your project organized, transparent, and moving forward.
          </p>

          <div className="relative mt-16 grid gap-6 md:grid-cols-4">
            <div className="absolute left-[12%] right-[12%] top-8 hidden h-px bg-stone-400/60 md:block" aria-hidden="true" />
            {processSteps.map((step, index) => (
              <article key={step.title} className="relative rounded-[1.75rem] border border-white/15 bg-white/[0.04] p-7 text-center shadow-lg">
                <div className="relative z-10 mx-auto flex h-16 w-16 items-center justify-center rounded-full border-4 border-slate-900 bg-stone-200 text-lg font-semibold text-slate-900">
                  {String(index + 1).padStart(2, "0")}
                </div>
                <div className="mx-auto mt-6 flex h-11 w-11 items-center justify-center rounded-full border border-white/20 text-2xl" aria-hidden="true">{step.icon}</div>
            ...
            {projects.map((project) => (
              <article key={project.title} className="group overflow-hidden rounded-[1.5rem] bg-white shadow-sm ring-1 ring-stone-200 transition hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <button type="button" onClick={() => setSelectedProject(project)} className="mt-5 text-sm font-semibold uppercase tracking-wide text-slate-900 underline-offset-4 hover:underline">
                    View Project →
                  </button>
                </div>
              </article>
