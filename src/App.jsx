      ...
      <section id="about" className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg text-slate-600 leading-8">
            Our journey began with a home built for our own family. We designed and constructed a custom duplex where our mother could live on one side and our family on the other, allowing us to stay close while each enjoying the comfort and privacy of our own home. That experience reinforced our belief that a home is more than just a building—it's a place where families grow, connect, and create lasting memories.
          </p>
          <p className="mt-6 text-lg text-slate-600 leading-8">
      ...
      <section id="contact" className="bg-stone-100 py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700">
            📧 Email: <a href="mailto:info@96homes.ca" className="underline">info@96homes.ca</a>
            <br />
          ...
          <form
            ...
            method="POST"
            className="mt-10 grid gap-5 rounded-[2rem] bg-white p-6 text-left shadow-sm ring-1 ring-stone-200 md:p-8"
          >
