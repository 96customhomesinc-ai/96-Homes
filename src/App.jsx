...
export default function Homes96Website() {
  ...
  const projects = [
    {
      ...
      details:
        "Custom residential work with premium finishes, modern layouts, and detailed craftsmanship from start to finish.",
    ...
    },
    {
      ...
      details:
        "A bright, open living space renovation featuring modern finishes, a feature fireplace, and refined interior details.",
    ...
    },
    {
      ...
      details:
        "A luxury bathroom renovation with a freestanding tub, glass shower, double vanity, black fixtures, and clean modern finishes.",
  ...
  const galleryImages = [
    ...
    { title: "Bathroom Renovation", image: "/images/bathroom-renovation.jpg" },
    { title: "Basement Bar", image: "/images/basement-bar.jpg" },
  ];
  ...
  const processSteps = [
    {
      step: "01",
      title: "Consultation",
      text: "We start with a conversation to understand your vision, goals, budget, and timeline.",
    },
    {
      step: "02",
      title: "Planning & Design",
      text: "We create a clear plan so every detail is organized before construction begins.",
    },
    {
      step: "03",
      title: "Construction",
      text: "Our team brings your project to life with skilled trades, quality materials, and careful management.",
    },
    {
      step: "04",
      title: "Final Walkthrough",
      text: "We review the completed work with you to make sure every detail meets expectations.",
    },
  ];
    ...
    <div className="min-h-screen bg-stone-50 text-slate-900">
      <header className="sticky top-0 z-50 border-b border-stone-200 bg-stone-50/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm text-slate-600 md:flex">
            ...
            <a href="#process" className="hover:text-black">Our Process</a>
          ...
          <div className="relative flex items-center gap-3">
            <a
              ...
              className="hidden lg:block rounded-full bg-black px-6 py-2 text-sm text-white hover:opacity-90"
            >
              Call Now
            </a>
            <button
              ...
              className="rounded-full border border-stone-300 bg-white px-4 py-3 text-2xl leading-none shadow-sm hover:bg-stone-100"
            >
              ☰
            </button>

            {menuOpen && (
              <div className="absolute right-0 top-14 w-56 overflow-hidden rounded-2xl border border-stone-200 bg-white text-sm shadow-xl">
                <a onClick={() => setMenuOpen(false)} href="#process" className="block px-5 py-3 hover:bg-stone-100">Our Process</a>
                <a onClick={() => setMenuOpen(false)} href="#gallery" className="block px-5 py-3 hover:bg-stone-100">Gallery</a>
                <a onClick={() => setMenuOpen(false)} href="#about" className="block px-5 py-3 hover:bg-stone-100">About Us</a>
                <a onClick={() => setMenuOpen(false)} href="#contact" className="block px-5 py-3 hover:bg-stone-100">Contact Us</a>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="grid gap-8 mt-12 md:grid-cols-3">
            {projects.map((p) => (
              <div key={p.title} className="overflow-hidden rounded-[1.75rem] bg-white shadow-sm ring-1 ring-stone-200 transition hover:shadow-xl">
                ...
                <div className="p-6">
                  <p className="mb-2 text-xs font-medium uppercase tracking-[0.18em] text-stone-500">{p.type}</p>
      ...
      <section id="gallery" className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="mt-3 text-center text-4xl font-semibold">Completed Project Photos</h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-slate-600">
            A collection of residential renovation and construction work completed by 96 Homes.
          </p>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {galleryImages.map((item) => (
              <div key={item.title} className="overflow-hidden rounded-[1.5rem] bg-white shadow-sm ring-1 ring-stone-200">
                <img src={item.image} alt={item.title} className="h-72 w-full object-cover transition duration-300 hover:scale-105" />
      ...
      <section id="process" className="bg-stone-100 py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-4">
            {processSteps.map((item) => (
              <div key={item.step} className="rounded-[1.75rem] bg-white p-7 shadow-sm ring-1 ring-stone-200">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-black text-sm font-semibold text-white">
                  {item.step}
                </div>
      ...
      <section id="testimonials" className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[1, 2, 3].map((item) => (
              <div key={item} className="rounded-[1.75rem] bg-stone-50 p-7 shadow-sm ring-1 ring-stone-200">
                <p className="text-lg text-amber-600">★★★★★</p>
                <p className="mt-4 text-sm leading-6 text-slate-600">
                  Add client testimonial here. Replace this text with a review from a homeowner or business client.
                </p>
                <p className="mt-5 font-semibold">Client Name</p>
